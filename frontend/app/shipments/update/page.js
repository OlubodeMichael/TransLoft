                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <h1 className="text-xl font-bold text-gray-900">Update Shipment</h1>
                        </div>
                        {shipmentDetails && (
                            <div className={`px-3 py-1 rounded-full border ${getStatusColor(shipmentDetails.status)}`}>
                    ...
                    <div className="bg-white shadow sm:rounded-lg mb-6">
                        <div className="px-4 py-5 sm:p-6 border-b">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <h3 className="text-xs font-medium text-gray-500">Shipment ID</h3>
                                    <p className="mt-1 text-sm text-gray-900">{shipmentDetails._id}</p>
                                </div>
                                <div>
                                    <h3 className="text-xs font-medium text-gray-500">Current Status</h3>
                                    <p className="mt-1 text-sm text-gray-900 capitalize">{shipmentDetails.status?.replace('-', ' ')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
