  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4 py-16">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Shipment Not Found</h2>
        <p className="text-gray-600 mb-8">
          Sorry, we couldn't find the shipment you're looking for. It might have been removed,
